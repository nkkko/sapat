...
@click.option("--api", "-a", type=click.Choice(['openai', 'groq', 'azure', 'deepgram'], case_sensitive=False), required=True, help="API to use for the transcription ('openai', 'groq', 'azure' or 'deepgram')")
