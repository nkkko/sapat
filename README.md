...
3. Create a `.env` file in the project root and add your API credentials:
   ...
   AWS_TRANSCRIBE_S3_BUCKET=your-sapat-media-bucket
   AWS_TRANSCRIBE_S3_PREFIX=sapat-transcribe
   AWS_TRANSCRIBE_LANGUAGE_CODE=en-US
   AWS_TRANSCRIBE_IDENTIFY_LANGUAGE=false
   ```
...
```
sapat my_video.mp4 --quality M --language en --api aws
```
